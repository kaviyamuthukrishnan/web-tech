...
public class ServiceRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // A ready-made CSS class name (priority-low / priority-medium / priority-high)
        // so the View can style the badge WITHOUT doing any string logic itself
        request.setAttribute("priorityClass", "priority-" + priority.toLowerCase());
